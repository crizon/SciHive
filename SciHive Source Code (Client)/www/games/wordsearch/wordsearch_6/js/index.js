    ...
    var endTurn = function () {
      ...
      for (var i = 0, len = wordList.length; i < len; i++) {
        ...
        if (wordList.length === 0) {
          ...
          /*---------------------------------------------------DITO TAYO MAGLALAGAY NG SCRIPT PAG TAPOS NA. GAMIT TAYO SWEETALERT-----------------------------------------------------------*/
          alert('Congratulations! You did a great job! 👍');
...
$(function () {
  var words = ['mammals', 'birds', 'fish', 'reptiles', 'nest', 'amphibian', 'insects', 'habitat', 'vertebrate', 'wings', 'scales', 'claws', 'tails', 'fur', 'swim'];
