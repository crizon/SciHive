...
Window_MenuCommand.prototype.addMAPCommand = function() {
    this.addCommand('VIEW MAP', 'CrizonMap');
};

//ADDING COMMAND SA MENU ===========================================================
Window_MenuCommand.prototype.addCancelCommand = function() {
    this.addCommand('CANCEL', 'CrizonCancelButton');
};
...
Window_MenuCommand.prototype.addGameEndCommand = function() {
    ...
    this.addCommand('QUIT GAME', 'gameEnd', enabled);
};
...
//PAMPAGITNA NG MENU TEXT--------------------------------------------------------------------
    ...
    this.addCommand("Help", 'Helpie')
    this.addCommand("Credits", 'toCredits')
    this.addCommand("Exit", 'Pota');
