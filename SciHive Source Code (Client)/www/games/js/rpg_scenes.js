...
Scene_Title.prototype.createCommandWindow = function() {
    ...
    //POTA EXIT=========================================================================================================
    this._commandWindow.setHandler('Pota',  this.commandPota.bind(this));

    //SWITCH TO CLASSIC=================================================================================================
    this._commandWindow.setHandler('toCredits',  this.commandtoCredits.bind(this));

    //HELP==============================================================================================================
    this._commandWindow.setHandler('Helpie',  this.commandHelpie.bind(this));
...
//POTA EXIT=========================================================================================================
Scene_Title.prototype.commandPota = function() {
    this._commandWindow.close();
...
//SWITCH TO CLASSIC=================================================================================================
Scene_Title.prototype.commandtoCredits = function() {
    this._commandWindow.close();
    var options = 'location=yes,closebuttoncaption=◀ CLOSE,toolbarcolor=#ffa500,hidenavigationbuttons=yes,hideurlbar=yes,hardwareback=no,zoom=no,shouldPauseOnSuspend=yes,clearsessioncache=yes,clearcache=yes';
    window.open('credits/index.html', '_blank', options);
    SceneManager.goto(Scene_Title);
};


//HELP=============================================================================================================
Scene_Title.prototype.commandHelpie = function() {
    this._commandWindow.close();
    var options = 'location=yes,closebuttoncaption=◀ CLOSE,toolbarcolor=#ffa500,hidenavigationbuttons=yes,hideurlbar=yes,hardwareback=no,zoom=no,shouldPauseOnSuspend=yes,clearsessioncache=yes,clearcache=yes';
    window.open('help/index.html', '_blank', options);
    SceneManager.goto(Scene_Title);
};
...
Scene_Menu.prototype.createCommandWindow = function() {
    ...
    //ADDING COMMAND SA MENU ===========================================================
    this._commandWindow.setHandler('CrizonMap',    this.commandMAP.bind(this));
    this._commandWindow.setHandler('CrizonCancelButton',    this.commandCANCEL.bind(this));
...
Scene_Menu.prototype.commandMAP = function() {
    var options = 'location=no,zoom=yes,shouldPauseOnSuspend=yes,clearsessioncache=yes,clearcache=yes';
    window.open('map1.html', '_blank', options);
    this.popScene();
};
